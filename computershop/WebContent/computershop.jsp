...
<img src="images/logo.jpg" alt="" height="50px" width="50px" style="float: left;">
  ...
  <div class="right">
    <div class="image">
      <a  onclick="loginfirst()"> <img src="images/1.jpg" alt="" id="myho">MOUSE PAD</a>&nbsp;&nbsp;&nbsp;&nbsp;

      <a  onclick="loginfirst()"> <img src="images/2.jpg" alt="" id="myho">MOTHER BOARD</a>&nbsp;&nbsp;&nbsp;&nbsp;

      <a  onclick="loginfirst()"> <img src="images/3.jpg" alt="" id="myho">CPU</a>&nbsp;&nbsp;&nbsp;&nbsp;

      

      <a  onclick="loginfirst()"> <img src="images/5.jpg" alt="" id="myho">MONITOR </a>&nbsp;&nbsp;&nbsp;&nbsp;
      
      <a onclick="loginfirst()"> <img src="images/6.jpg" alt="" id="myho">STORAGE</a>&nbsp;&nbsp;&nbsp;&nbsp;

      <a onclick="loginfirst()"> <img src="images/7.jpg" alt="" id="myho">FAN</a>&nbsp;&nbsp;&nbsp;&nbsp;

     
      <a onclick="loginfirst()"> <img src="images/10.jpg" alt="" id="myho">KEYBOARD</a>&nbsp;&nbsp;&nbsp;&nbsp;
