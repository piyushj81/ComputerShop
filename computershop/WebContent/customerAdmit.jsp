...
<body>
  ...
  if(ms != null){
		if(ms.equals("Failed"))  {
			out.println("<h2 style='color: red;'> Registration failed due to same Phone number try other phone number  </h2>");

		} else {
			out.println("<h2 style='color:green;' >" +ms+ " </h2>");

		}
	}
  
  %>
   <form action="customerAdmit" method="post">
